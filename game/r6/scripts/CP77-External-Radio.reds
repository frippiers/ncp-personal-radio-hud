...
private cb func OnMountingEvent(evt: ref<MountingEvent>) -> Bool{
    ...
    // NC PERSONAL: radio must be turned ON explicitly by selecting a station
    // (removed the original auto-play-on-vehicle-entry behaviour).
    // Entering a vehicle no longer auto-starts the external station.
